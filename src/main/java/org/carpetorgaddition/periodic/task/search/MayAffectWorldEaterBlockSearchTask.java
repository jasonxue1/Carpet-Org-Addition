...
public class MayAffectWorldEaterBlockSearchTask extends BlockSearchTask {
    public MayAffectWorldEaterBlockSearchTask(ServerWorld world, BlockPos sourcePos, BlockRegion blockRegion, ServerCommandSource source, BlockStatePredicate predicate) {
        super(world, sourcePos, blockRegion, source, predicate);
    }
